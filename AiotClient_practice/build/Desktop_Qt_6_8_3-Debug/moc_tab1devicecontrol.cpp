...
Q_CONSTINIT const QMetaObject Tab1DeviceControl::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17Tab1DeviceControlE_t,
        ...
        // method 'on_pDialLed_valueChanged_sig'
...
void Tab1DeviceControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pDialLed_valueChanged_sig((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        case 7: _t->activateCheckBoxSlot((*reinterpret_cast< std::add_pointer_t<QStringList&>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &Tab1DeviceControl::on_pDialLed_valueChanged_sig; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Tab1DeviceControl::on_pDialLed_valueChanged_sig(QString _t1)
{
